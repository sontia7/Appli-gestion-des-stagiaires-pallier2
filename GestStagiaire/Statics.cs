...
namespace GestStagiaire
{
    public static class Lire
    {
        ...
        {
            Console.WriteLine($"{message} (Bachelier-->{vrai}/Master-->{faux}):");
        ...
        public static int UnInteger(string message, int min = 0, int max = 999999, bool separation = false)
        {
            byte Resultat = byte.MinValue;
        ...
        public static int LireNote(string message, int min = 0, int max = 20, bool separation = false)
        {
            byte Resultat = byte.MinValue;
